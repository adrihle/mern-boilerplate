//rest api urls
export const urlAPI_UPLOAD_USER = 'http://localhost:4000/newUser'
export const urlAPI_SIGN_IN = 'http://localhost:4000/login'
//sign in user
...
//change sign page
export const SIGN_PAGE_CHANGE = 'SIGN_PAGE_CHANGE'